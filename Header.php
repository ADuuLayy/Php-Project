...
<body>
  ...
  <header>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 text-right text-sm">
            <div class="social-mini-button">
              ...
              <a href="https://www.dribbble.com"><span class="mai-logo-dribbble"></span></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Nex</span>-Company</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            <li >
              <a class="nav-link" href="EmployeeDashboard.php">Home</a>
            </li>
            <li>
            ...
            <li >
              <a class="nav-link" href="Employee.php">Employee Register</a>
            </li>
            <li class="nav-item">
